  ...
  return (
    <div className="main-info rounded-white">
      ...
      <span className="the-description">
        <h3>Karen - The Movie Soundtrack Open Edition & Limited Edition + Bonus NFT</h3>
        Emmersive Entertainment and BET Network/Viacom, Flixville USA, and A Tiny Universe have teamed up to present an
        exclusive release of the Karen - The Movie official soundtrack, produced by RIAA Gold and Platinum-certified record
        producer Adrian Miller, and Grammy-award winning producer Om’Mas Keith. The soundtrack features 11 songs with
        various artists such as CeeLo Green, Knox Brown ft. Anderson .Paak, Gumbo, and others. <br /><br />
        The Limited Edition + Bonus features not only the 11-song soundtrack, but the official Karen Movie Poster, 3 Music
        Videos, 9 pieces of custom Artwork related to the soundtrack music videos, Special Message from the Director, and
        the official Score to the movie.
        <br /><br />
        <b>Song Credits:</b>
        <br />
        “For A Reason” - Jaycee
        ...
        Performed by Brown Family Choir - Jason Brown/Lea Rutherford/La Triece Rutherford/Adrien Douglas /Garren
        Edmondson/Lynn Edmondson /Robbie Brown/Jimmy Brown/Kermit Stringfellow <br />
